...
namespace Nelikentta
{
    public partial class Form1 : Form
    {
        ...
        // Siirrytään pois aloitussivulta
        private void AlkuSivuSeuraavaBtn_Click(object sender, EventArgs e)
        {
            AlkuPL.Visible = false;
            EsimerkkiPL.Visible = true;
        }

        // Palataan aloitussivulle
        private void TakaisinAloitusSivuBtn_Click(object sender, EventArgs e)
        {
            EsimerkkiPL.Visible = false;
            AlkuPL.Visible = true;
        }

        // Siirrytään pois esimerkkisivulta
        ...
        // Teksti joka kehottaa klikkaamaan on näkyvissä, ellei toisin käsketä
        private void Nayta()
        {
        ...
        // YLÄ-VASEN PANEELI
        // Piilotetaan muiden paneelien ominaisuudet ja tuodaan niistä näkyviin vain klikkaa-teksti
        ...
        private void YlaVasLisaaBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                // Kun vasemmalla on 6 labelia, ohjelma alkaa lisäämään niitä oikealle
                if (YlaVasFullStop == 6)
                {
                    YlaVasFullStop = 6;
                    YlaVasTop = 10;
                    ...
                    // Oikeaan reunaan voidaan lisätä vielä 6 labelia, jonka jälkeen kenttä on tullut täyteen
                ...
                // kun 12 labelia on lisätty, ohjelma ei anna lisätä enempää
                if (YlaVasFullStop == 0)
                {
        ...
        // Koodi toistaa itseään tästä eteenpäin
        // Tähän on varmasti parempikin ratkaisu olemassa, tässä kuitenkin mitä sain lyhyessä ajassa aikaan
        ...
        private void ValmisBtn_Click(object sender, EventArgs e)
        {
            this.Close();
        }
